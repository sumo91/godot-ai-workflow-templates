...
这个仓库本身就可以作为“项目内工作流模板”独立使用。

但如果你想获得更强的日常使用体验，我们仍然强烈建议配合下面两个本地增强项一起使用：

- `superpowers`：更强的流程约束、技能化工作流、角色化执行能力
- `godot-mcp`：更强的 Godot 感知能力，以及更深入的项目 / 编辑器联动

这两个都属于推荐增强项，不是本仓库的硬依赖。
